...
export default function Home() {
  ...
  const renderMintOption = (amountInUSD: number) => (
    <div className="flex flex-col items-center p-8 bg-gray-800 rounded-lg shadow-2xl
    transition-transform transform hover:scale-105">
      <h2 className="text-3xl font-bold mb-4 text-white text-center">
        ${amountInUSD} <span className="text-sm text-gary-400">
          (~{ethPriceinUSD && (amountInUSD / ethPriceinUSD).toFixed(4)} ETH)</span>
      </h2>
      <Button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white 
        font-bold py-3 px-6 rounded-full hover:from-blue-600 hover:to-purple-600
        transition duration-300" onClick={() => mint(amountInUSD)}>
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900">
      ...
      <div className="p-5 grow flex flex-col items-center justify-center">
        {isConnected ? (
          <>
            <h1 className="text-5xl font-extrabold mb-8 text-white">Mint Your Own HUGO Tokens</h1>
